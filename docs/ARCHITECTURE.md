...
1. [`../PLAN.md`](../PLAN.md) §0 — guiding principles.
2. [`../PLAN.md`](../PLAN.md) §2 — the six layers in detail.
3. [`../PLAN.md`](../PLAN.md) §14 — the worked SQL-query example.
...
- **Shared-nothing reactors by default; cross-loop only by explicit
  channel/mailbox/shared-buffer handle.**  See PLAN.md §0.2, §2.3.
- **Configure-time backend selection, never runtime.**  No vtable
  on the hot path.  See PLAN.md §0.7, §2.2.
...
- **Mechanical change as doctrine.**  Structural change goes
  through `dist/s_*` generators.  See PLAN.md §18.3.
