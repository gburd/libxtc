...
fail=0
for t in test_sim_sched test_sim_pingpong test_sim_fault test_sim_soak test_sim_critsec test_sim_latch test_sim_iofault test_sim_buggify test_sim_buggify2; do
	exe="$work/$t"
