...
fail=0
for t in test_sim_sched test_sim_pingpong test_sim_fault test_sim_soak test_sim_critsec test_sim_latch test_sim_lockmgr test_sim_lwlock test_sim_lrlock test_sim_rcu test_sim_iofault test_sim_buggify test_sim_buggify2 test_sim_buggify3 test_sim_partition test_sim_machine_death test_sim_svr test_sim_chan test_sim_sync test_sim_reg test_sim_mctx test_sim_slab test_sim_pdict test_sim_stats test_sim_swarm test_sim_bufmgr test_sim_crash_recover; do
	exe="$work/$t"
