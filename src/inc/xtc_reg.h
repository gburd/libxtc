 ...
 * entries removed. */
int  xtc_reg_drop_pid(xtc_reg_t *r, xtc_pid_t pid);
...
int  xtc_reg_register_mon(xtc_reg_t *r, const char *name, xtc_pid_t pid);
 ...
 * pattern). */
int  xtc_svr_call_name(xtc_reg_t *r, const char *name,
