...
int xtc_exec_class_create __P((xtc_loop_t *, int, int64_t, xtc_exec_class_t *));
int xtc_exec_class_shares __P((xtc_exec_class_t));
...
int64_t xtc_exec_class_latency __P((xtc_exec_class_t));
struct xtc_res *xtc_loop_res __P((xtc_loop_t *));
uint64_t __xtc_sim_rng __P((int));
uint64_t __xtc_sim_rng_range __P((int, uint64_t));
uint64_t xtc_exec_class_runs __P((xtc_exec_class_t));
uint64_t xtc_exec_class_vruntime __P((xtc_exec_class_t));
uint64_t xtc_loop_stall_count __P((const xtc_loop_t *));
...
void xtc_exec_set_stall_budget __P((xtc_exec_t *, int64_t));
void xtc_exec_set_steal_backoff __P((xtc_exec_t *, int));
void xtc_loop_set_stall_budget __P((xtc_loop_t *, int64_t));
void xtc_loop_set_stall_cb __P((xtc_loop_t *, xtc_stall_cb, void *));
