...
rem --- :run_plain <milestone> <testname>  (like :run_munit but for a
rem     STANDALONE driver with its own main() and no munit.c) ---
:run_plain
set MS=%~1
set TN=%~2
cl %CFLAGS% /Fe:%TN%.exe ^
